...
<div class="container my-2 text-light">
    <h1><fmt:message key="order.management.headline"/></h1>
    ...
    <div class="dropdown mb-3">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <li>
                <c:url value="/admin/orders" var="showAllUrl">
            ...
            <li>
                <c:url value="/admin/orders" var="burgersFilterUrl">
                    <c:param name="sortField" value="${sortField}"/>
                    <c:param name="sortDir" value="${reverseSortDir}"/>
            ...
            <li>
            <li>
                <c:url value="/admin/orders" var="drinksFilterUrl">
                    <c:param name="sortField" value="${sortField}"/>
                    <c:param name="sortDir" value="${reverseSortDir}"/>
            ...
            <li>
                <c:url value="/admin/orders" var="snacksFilterUrl">
                    <c:param name="sortField" value="${sortField}"/>
                    <c:param name="sortDir" value="${reverseSortDir}"/>
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <th>
                <c:url value="/admin/orders" var="nameSortUrl">
            ...
            <th>
                <c:url value="/admin/orders" var="categorySortUrl">
            ...
            <th>
                <c:url value="/admin/orders" var="descriptionSortUrl">
            ...
            <th>
                <c:url value="/admin/orders" var="priceSortUrl">
        ...
        <c:forEach var="order" items="${orderPaged.pageContent}">
            <tr>
                ...
                <td>
                    ...
                    <c:url value="/admin/orders" var="declineUrl">
                    <c:param name="action" value="decline"/>
                    ...
                    <c:if test="${order.status.ordinal() < 3}">
                    <form method="post" action="${nextStageUrl}" class="d-inline">
                        <input type="hidden" name="id" value="${order.id}">
                        <button
                                class="btn btn-primary" type="submit"><fmt:message key="order.next.stage"/>
                        </button>
                    </form>

                    <form method="post" action="${declineUrl}" class="d-inline">
                        <input type="hidden" name="id" value="${order.id}">
                        <button
                                class="btn btn-danger" type="submit"><fmt:message key="order.decline"/>
                        </button>
                    </form>
                    </c:if>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <li>
                        <c:url value="/admin/orders" var="pageSizeFilterUrl5">
                            <c:param name="sortField" value="${sortField}"/>
                            <c:param name="sortDir" value="${sortDir}"/>
                            <c:param name="filterStatus" value="${filterStatus}"/>
                    ...
                    <li>
                        <c:url value="/admin/orders" var="pageSizeFilterUrl10">
                            <c:param name="sortField" value="${sortField}"/>
                            <c:param name="sortDir" value="${sortDir}"/>
                            <c:param name="filterStatus" value="${filterStatus}"/>
                    ...
                    <li>
                        <c:url value="/admin/orders" var="pageSizeFilterUrl20">
                            <c:param name="sortField" value="${sortField}"/>
                            <c:param name="sortDir" value="${sortDir}"/>
                            <c:param name="filterStatus" value="${filterStatus}"/>
                    ...
                    <li>
                        <c:url value="/admin/orders" var="pageSizeFilterUrl30">
                            <c:param name="sortField" value="${sortField}"/>
                            <c:param name="sortDir" value="${sortDir}"/>
                            <c:param name="filterStatus" value="${filterStatus}"/>
            ...
            <c:if test="${orderPaged.paging.totalPages > 1}">
                <ul class="pagination">
                    <li class="page-item ${!orderPaged.paging.prevEnabled ? 'disabled' : ''}">
                        ...
                        <c:url value="/admin/orders" var="previousLink">
                            <c:param name="sortField" value="${sortField}"/>
                            <c:param name="sortDir" value="${sortDir}"/>
                            <c:param name="filterStatus" value="${filterStatus}"/>
                            <c:param name="pageSize" value="${pageSize}"/>
                    ...
                    <c:forEach var="item" items="${orderPaged.paging.items}">
                        ...
                        <c:if test="${item.pageItemType.name() == 'PAGE'}">
                            <li class="page-item ${item.index == orderPaged.paging.pageNumber ? 'active' : ''}">
                                <c:url value="/admin/orders" var="paginationUrl">
                                    <c:param name="sortField" value="${sortField}"/>
                                    <c:param name="sortDir" value="${sortDir}"/>
                                    <c:param name="filterStatus" value="${filterStatus}"/>
                                    <c:param name="pageSize" value="${pageSize}"/>
                    ...
                    <li class="page-item ${!orderPaged.paging.nextEnabled ? 'disabled' : ''}">
                        <c:url value="/admin/orders" var="nextLink">
                            <c:param name="sortField" value="${sortField}"/>
                            <c:param name="sortDir" value="${sortDir}"/>
                            <c:param name="filterStatus" value="${filterStatus}"/>
                            <c:param name="pageSize" value="${pageSize}"/>
